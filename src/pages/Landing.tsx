...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <p style={{
      ...
      color: "rgba(245,244,240,0.40)", margin: "0 0 16px",
    }}>
      {children}
    </p>
  )
...
export default function Landing() {
  ...
  return (
    <div style={{ backgroundColor: C.oxblood, fontFamily: F.body, color: C.ash }}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .hero-grid    { display: grid; grid-template-columns: 1fr 400px; gap: 64px; align-items: start; }
        ...
        @media (max-width: 768px) {
          ...
          .mobile-cta   {
            ...
            background: ${C.amber}; padding: 14px 20px;
      ...
      <nav style={{
        ...
        height: 56, backgroundColor: C.oxblood,
        ...
        <div style={{ maxWidth: 1200, width: "100%", margin: "0 auto", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px" }}>
          ...
          <span style={{ fontFamily: F.body, fontSize: 14, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: C.ash }}>
            Sundial
          </span>
          ...
          <div className="desktop-only" style={{ gap: 32, alignItems: "center" }}>
            {[["#overview", "Overview"], ["#use-cases", "Use Cases"], ["#", "Changelog"], ["https://github.com/pepdek/PracticeIQ", "GitHub"]].map(([href, label]) => (
              <a key={label} href={href} target={href.startsWith("http") ? "_blank" : undefined} rel={href.startsWith("http") ? "noopener noreferrer" : undefined}
                style={{ fontFamily: F.body, fontSize: 14, fontWeight: 500, color: "rgba(245,244,240,0.6)", textDecoration: "none", transition: "color 150ms" }}
          ...
          <div className="desktop-only" style={{ alignItems: "center" }}>
            <div style={{
              ...
              <div style={{ padding: "0 14px", display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontFamily: F.display, fontSize: 22, fontWeight: 700, color: C.gold, lineHeight: 1 }}>74</span>
          ...
          <div className="hero-grid">
            ...
            <div>
              <div style={{ display: "inline-block", marginBottom: 28 }}>
                <span style={{ fontFamily: F.mono, fontSize: 11, color: "rgba(245,244,240,0.5)", border: "1px solid rgba(245,244,240,0.2)", borderRadius: 4, padding: "2px 8px" }}>
                  2.0
                </span>
              </div>
              ...
              <p style={{
                fontFamily: F.body, fontSize: "clamp(15px, 1.2vw, 17px)", color: "rgba(245,244,240,0.82)",
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 18 }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <span style={{ fontFamily: F.display, fontSize: 38, fontWeight: 700, lineHeight: 1, color: C.gold, display: "block" }}>74</span>
                    <span style={{ fontFamily: F.mono, fontSize: 9, color: C.slate }}>this week</span>
                  </div>
                </div>
                ...
                {["One email. Every Sunday. No logins.", "Five dimensions. All sourced from your data.", "Connects to Clio, Plaid, and Google.", "Your first score, free."].map(item => (
                  <div key={item} style={{ display: "flex", gap: 9, marginBottom: 10, alignItems: "flex-start" }}>
                    <span style={{ color: C.amber, fontSize: 13, lineHeight: "19px", flexShrink: 0, fontWeight: 700 }}>✓</span>
                  ...
                  {[["Revenue", 12.5], ["Velocity", 17], ["Risk", 16], ["Financial", 13.5], ["Reputation", 13]].map(([label, score]) => (
                    <div key={String(label)} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }}>
                      ...
                      <div style={{ flex: 1, height: 3, background: C.smoke, borderRadius: 2 }}>
                        <div style={{ height: 3, borderRadius: 2, width: `${(Number(score) / 20) * 100}%`, background: Number(score) >= 16 ? C.green : Number(score) >= 12 ? C.gold : "#ef4444" }} />
                      </div>
                ...
                <button onClick={onCTA} style={{
                  width: "100%", background: C.amber, border: "none", cursor: "pointer",
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.10)", borderBottom: "1px solid rgba(255,255,255,0.10)", padding: "40px 0", overflow: "hidden" }} id="overview">
        <p style={{ fontFamily: F.body, fontSize: 11, fontWeight: 500, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(245,244,240,0.4)", textAlign: "center", marginBottom: 24, marginTop: 0 }}>
          ...
          <div className="ticker-track">
            {[...TICKER_CARDS, ...TICKER_CARDS].map((card, i) => (
              <div key={i} style={{
                ...
                <p style={{ fontFamily: F.mono, fontSize: 9, color: "rgba(245,244,240,0.4)", margin: "0 0 8px" }}>Week ending {card.week}</p>
                <p style={{ fontFamily: F.body, fontSize: 13, fontWeight: 600, color: C.ash, margin: "0 0 5px", lineHeight: 1.3 }}>{card.headline}</p>
                <p style={{ fontFamily: F.body, fontSize: 12, color: "rgba(245,244,240,0.55)", margin: 0, lineHeight: 1.5 }}>{card.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="section-pad" style={{ maxWidth: 1200, margin: "0 auto", padding: "96px 32px" }}>
          ...
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(26px, 3vw, 44px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 48px", maxWidth: 640 }}>
          ...
          <div className="grid-2" style={{ marginBottom: 56 }}>
            {[
              ...
              <div key={q} style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.10)", borderRadius: 8, padding: "20px 24px" }}>
                <p style={{ fontFamily: F.body, fontSize: 13, color: "rgba(245,244,240,0.55)", lineHeight: 1.5, margin: "0 0 14px" }}>{q}</p>
                <p style={{ fontFamily: F.display, fontSize: 26, fontWeight: 700, color: "rgba(245,244,240,0.18)", margin: 0, letterSpacing: "-0.02em" }}>Unknown.</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }} className="grid-2">
            <div>
              <blockquote style={{
                ...
                fontWeight: 400, fontStyle: "italic", color: C.gold, lineHeight: 1.55,
                margin: "0 0 14px",
            ...
            <div style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.10)", borderRadius: 10, padding: "28px 32px" }}>
              <p style={{ fontFamily: F.body, fontSize: 13, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "rgba(245,244,240,0.35)", margin: "0 0 16px" }}>
                Clio knows your matters.
              </p>
              <p style={{ fontFamily: F.display, fontSize: "clamp(18px, 1.8vw, 24px)", fontWeight: 700, color: C.ash, lineHeight: 1.3, margin: "0 0 16px" }}>
                It doesn't know your practice. There's a difference.
              </p>
              <p style={{ fontFamily: F.body, fontSize: 15, color: "rgba(245,244,240,0.70)", lineHeight: 1.65, margin: 0 }}>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} id="how-it-works">
        <div className="section-pad" style={{ maxWidth: 640, margin: "0 auto", padding: "96px 32px" }}>
          ...
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 36px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 48px" }}>
          ...
          {["Connect your practice management software", "Connect your bank account via Plaid", "Confirm your email address"].map((step, i) => (
            <div key={i} style={{ display: "flex", gap: 20, marginBottom: i < 2 ? 28 : 0, alignItems: "flex-start" }}>
              <span style={{ fontFamily: F.mono, fontSize: 13, color: C.gold, flexShrink: 0, marginTop: 2, minWidth: 20 }}>{i + 1}.</span>
              <p style={{ fontFamily: F.body, fontSize: 17, color: C.ash, lineHeight: 1.5, margin: 0 }}>{step}</p>
            </div>
          ))}

          <p style={{ fontFamily: F.display, fontSize: 18, fontStyle: "italic", color: "rgba(245,244,240,0.40)", margin: "44px 0 0" }}>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} id="use-cases">
        <div className="section-pad" style={{ maxWidth: 1200, margin: "0 auto", padding: "96px 32px" }}>
          ...
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 36px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 40px", maxWidth: 520 }}>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="section-pad" style={{ maxWidth: 800, margin: "0 auto", padding: "96px 32px" }}>
          ...
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 36px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 36px" }}>
              ...
              <thead>
                <tr style={{ background: "rgba(255,255,255,0.06)" }}>
                  {["Platform", "Connection", "What you'll see"].map(h => (
                    <th key={h} style={{ fontFamily: F.body, fontSize: 11, fontWeight: 600, color: "rgba(245,244,240,0.45)", textAlign: "left", padding: "10px 16px", letterSpacing: "0.06em", textTransform: "uppercase", borderBottom: "1px solid rgba(255,255,255,0.10)" }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={platform} style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
                    <td style={{ fontFamily: F.body, fontSize: 13, fontWeight: 500, color: C.ash, padding: "11px 16px" }}>{platform}</td>
                    <td style={{ fontFamily: F.mono, fontSize: 11, color: "rgba(245,244,240,0.50)", padding: "11px 16px" }}>{conn}</td>
                    <td style={{ fontFamily: F.body, fontSize: 13, color: "rgba(245,244,240,0.65)", padding: "11px 16px" }}>{what}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <p style={{ fontFamily: F.body, fontSize: 13, color: "rgba(245,244,240,0.30)", marginTop: 20, fontStyle: "italic" }}>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} id="pricing">
        <div className="section-pad" style={{ maxWidth: 1100, margin: "0 auto", padding: "96px 32px" }}>
          <div style={{ textAlign: "center", maxWidth: 600, margin: "0 auto 48px" }}>
            ...
            <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 36px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 14px" }}>
              Pay once a month. Know your practice forever.
            </h2>
            <p style={{ fontFamily: F.body, fontSize: 16, color: "rgba(245,244,240,0.60)", margin: 0, lineHeight: 1.65 }}>
          ...
          <div className="grid-3">
            {[
              { name: "Solo", price: "$149", period: "/mo", desc: "One attorney. One practice management connection. Plaid. Google. The weekly email that changes how you see your own business.", highlight: false, cta: "Get started" },
              { name: "Firm", price: "$299", period: "/mo", desc: "Up to four attorneys. Multi-platform support. Every attorney gets their own email. You get the firm-level roll-up.", highlight: true, cta: "Get started" },
              { name: "LawStack", price: "$99", period: "/mo for 6 months", desc: "Already on LawStack? Your Clio connection already exists. Add Plaid. Add Google. Ten minutes.", highlight: false, cta: "Sign in with LawStack" },
            ].map(({ name, price, period, desc, highlight, cta }) => (
              <div key={name} style={{
                background: C.white,
                border: `${highlight ? 2 : 1}px solid ${highlight ? C.amber : "rgba(255,255,255,0.15)"}`,
                borderRadius: 12, padding: 28,
                boxShadow: highlight ? "0 8px 32px rgba(0,0,0,0.30)" : "none",
              }}>
                {highlight && (
                  <div style={{ marginBottom: 10 }}>
                    <span style={{ fontFamily: F.body, fontSize: 10, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: C.ember, background: "rgba(217,79,43,0.08)", borderRadius: 999, padding: "3px 9px" }}>
                      Most popular
                    </span>
                  </div>
                )}
                ...
                onMouseEnter={e => { const el = e.currentTarget; el.style.background = highlight ? C.amberDark : C.coal; el.style.borderColor = highlight ? C.amberDark : C.coal; el.style.color = C.white }}
          ...
          <p style={{ fontFamily: F.body, fontSize: 13, color: "rgba(245,244,240,0.35)", textAlign: "center", marginTop: 24, fontStyle: "italic" }}>
      ...
      <section style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }} id="faq">
        <div className="section-pad" style={{ maxWidth: 720, margin: "0 auto", padding: "96px 32px" }}>
          <Eyebrow>FAQ</Eyebrow>
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 32px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 40px" }}>
            Common questions.
          </h2>
          {FAQS.map((faq, i) => (
            <div key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.09)" }}>
              ...
              >
                <span style={{ fontFamily: F.body, fontSize: 15, fontWeight: 600, color: C.ash, lineHeight: 1.3, paddingRight: 16 }}>{faq.q}</span>
                <span style={{ color: C.amber, fontSize: 18, flexShrink: 0, transform: openFaq === i ? "rotate(90deg)" : "rotate(0deg)", transition: "transform 300ms ease", display: "inline-block" }}>›</span>
              </button>
              <div style={{ maxHeight: openFaq === i ? 300 : 0, overflow: "hidden", transition: "max-height 300ms ease" }}>
                <p style={{ fontFamily: F.body, fontSize: 14, color: "rgba(245,244,240,0.55)", lineHeight: 1.65, padding: "0 0 18px", margin: 0 }}>{faq.a}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ════════════════════════════════════════════════════════════════
          FOOTER CTA
      ════════════════════════════════════════════════════════════════ */}
      <section style={{ backgroundColor: C.oxbloodDim, borderTop: "1px solid rgba(255,255,255,0.10)" }}>
        <div className="section-pad" style={{ maxWidth: 640, margin: "0 auto", padding: "96px 32px", textAlign: "center" }}>
          <h2 style={{ fontFamily: F.display, fontSize: "clamp(22px, 2.5vw, 38px)", fontWeight: 700, lineHeight: 1.1, color: C.ash, letterSpacing: "-0.02em", margin: "0 0 18px" }}>
            One number. Every week. From your own data.
          </h2>
          <p style={{ fontFamily: F.body, fontSize: 17, color: "rgba(245,244,240,0.65)", lineHeight: 1.65, margin: "0 0 36px" }}>
          ...
          <p style={{ fontFamily: F.body, fontSize: 11, color: "rgba(245,244,240,0.30)", marginTop: 14 }}>
      ...
      {/* ════════════════════════════════════════════════════════════════
          FOOTER
      ════════════════════════════════════════════════════════════════ */}
      <footer style={{ backgroundColor: C.oxbloodDim, borderTop: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "56px 32px 40px", display: "flex", flexWrap: "wrap", justifyContent: "space-between", gap: 40 }}>
          <div>
            <p style={{ fontFamily: F.body, fontSize: 13, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: C.ash, margin: "0 0 6px" }}>Sundial</p>
            <p style={{ fontFamily: F.body, fontSize: 12, color: "rgba(245,244,240,0.35)", margin: "0 0 4px" }}>Designed, built, and backed by LawStack Inc.</p>
            <p style={{ fontFamily: F.body, fontSize: 11, color: "rgba(245,244,240,0.20)", margin: 0, fontStyle: "italic" }}>one number. every week. your practice, finally legible.</p>
          </div>
          <div style={{ display: "flex", gap: 48 }}>
            <div>
              <p style={{ fontFamily: F.body, fontSize: 10, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(245,244,240,0.25)", margin: "0 0 10px" }}>Product</p>
              {[["#overview","Overview"],["#use-cases","Use Cases"],["#pricing","Pricing"],["#faq","FAQ"]].map(([href, label]) => (
                <div key={href} style={{ marginBottom: 7 }}>
                  <a href={href} style={{ fontFamily: F.body, fontSize: 13, color: "rgba(245,244,240,0.40)", textDecoration: "none" }}
                    onMouseEnter={e => (e.currentTarget.style.color = C.ash)}
                    onMouseLeave={e => (e.currentTarget.style.color = "rgba(245,244,240,0.40)")}
                  >{label}</a>
                </div>
              ))}
            </div>
            <div>
              <p style={{ fontFamily: F.body, fontSize: 10, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(245,244,240,0.25)", margin: "0 0 10px" }}>Legal</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "20px 32px 32px", borderTop: "1px solid rgba(255,255,255,0.07)", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
          <p style={{ fontFamily: F.body, fontSize: 11, color: "rgba(245,244,240,0.20)", margin: 0 }}>© 2026 LawStack Inc. All rights reserved.</p>
          <p style={{ fontFamily: F.body, fontSize: 11, color: "rgba(245,244,240,0.20)", margin: 0 }}>legal@lawstack.co · privacy@lawstack.co</p>
        </div>
      </footer>
